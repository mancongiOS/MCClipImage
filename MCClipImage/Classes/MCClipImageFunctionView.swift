...
public class MCClipImageFunctionView: UIView {
    ...
    lazy var cancelButton: UIButton = {
        ...
        let image = Bundle.MCLoadImageFromBundleName("MCScanBundle", podName: "MCComponentFunction", imageName: "ClipImage_cancel")
    ...
    lazy var rotatingButton: UIButton = {
        let button = UIButton.init(type: UIButton.ButtonType.custom)
        let image = Bundle.MCLoadImageFromBundleName("MCScanBundle", podName: "MCComponentFunction", imageName: "ClipImage_rotating")
        button.setImage(image, for: .normal)
    ...
    lazy var sureButton: UIButton = {
        let button = UIButton.init(type: UIButton.ButtonType.custom)
        let image = Bundle.MCLoadImageFromBundleName("MCScanBundle", podName: "MCComponentFunction", imageName: "ClipImage_sure")
        button.setImage(image, for: .normal)
        return button
    }()
